...
contract TASTIES is ERC721A, Ownable {
    ...
    bytes32 private merkleRoot =
        0x319fac0faacb792338a9b62e1ac48b7d110bd85611ee36cb58d5105b771c64df;
    ...
    function mintItem(uint256 _quantity, bytes32[] calldata proof)
        external
        payable
        callerIsUser
    ...
    {
        require(
            _quantity > 0 && _saleMints[msg.sender] + _quantity <= 1,
            "Minting above limit"
        );
        require(_saleActive);
        uint256 totalMinted = _tokenIds.current();
